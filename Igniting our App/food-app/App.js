...
const cardList = [
    {
      "info": {
        ...
        "availability": {
          "nextCloseTime": "2023-11-23 11:59:00",
          "opened": true
        },
        "badges": {
          "textExtendedBadges": [
      ...
      "analytics": {
        "context": "seo-data-77d8f85f-1781-4085-818a-3005f1c391bf"
      },
      "cta": {
    ...
    },
    {
      "info": {
        ...
        "availability": {
          "nextCloseTime": "2023-11-23 15:30:00",
          "opened": true
        },
        "badges": {
          "imageBadges": [
    ...
    },
    {
      "info": {
        ...
        "availability": {
          "nextCloseTime": "2023-11-23 22:59:00",
          "opened": true
        },
        "badges": {
          "textExtendedBadges": [
    ...
    },
    {
      "info": {
        ...
        "availability": {
          "nextCloseTime": "2023-11-23 11:00:00",
          "opened": true
        },
        "badges": {
          "imageBadges": [
...
const RestaurantCard = (props) => {
    ...
    return (
        <div className="res-card">
            <img alt="res-logo" className="res-logo" src={"https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_660/" + cloudinaryImageId}></img>
            <h2>{name}</h2>
            <h4>{cuisines.join(", ")}</h4>
            <h4>{costForTwo}</h4>
    ...
    return (
        <div className="body">
            ...
            <div className="res-container">
                {
                    cardList.map((resttaurentData) => (<RestaurantCard key = {resttaurentData.info.id} restData={resttaurentData}></RestaurantCard> ))
                }
            </div>
        </div>
    )
